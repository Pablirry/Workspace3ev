...
public class Prueba {
    ...
    public static void main(String[] args) {
        ...
        Apartamento a;
        try {
            a = edificio.getApartamento(1, 'B');
            System.out.println("Apartamento buscado 1-B");
            System.out.println(a.toString());
        } catch (ExcepcionApartamentoNoEncontrado e1) {
            System.out.println(e1.toString());
        }
        try {
            List<Propietario> lista = edificio.getPropietarios(1, 'A');
            System.out.println("Propietarios apartamento 1-A");
            for (Propietario p : lista) {
                System.out.println(p.toString());
            }
        } catch (ExcepcionApartamentoNoEncontrado e) {
            e.addSuppressed(e);
        }
